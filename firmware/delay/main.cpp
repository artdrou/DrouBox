...
static droubox::DelayEffect delay(controls, {
    .knobTimeL    = DelayEffectConfig{}.knobTimeL,
    .knobTimeR    = DelayEffectConfig{}.knobTimeR,
    .knobFeedback = DelayEffectConfig{}.knobFeedback,
    .knobBlend    = DelayEffectConfig{}.knobBlend,
    .knobModRate  = DelayEffectConfig{}.knobModRate,
    .knobModDepth = DelayEffectConfig{}.knobModDepth,
});
