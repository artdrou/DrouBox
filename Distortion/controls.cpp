...
void updateKnobs()
{
    ...
    knob1 = hw.adc.GetFloat(KNOB_1);
    knob2 = hw.adc.GetFloat(KNOB_2);
    knob3 = hw.adc.GetFloat(KNOB_3);
    knob4 = hw.adc.GetFloat(KNOB_4);
    knob5 = hw.adc.GetFloat(KNOB_5);
    knob6 = hw.adc.GetFloat(KNOB_6);
}
